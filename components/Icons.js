const ShitIKnow = () => {
    return (
        <div className='flex-1 flex flex-wrap justify-center'>
              <svg xmlns="http://www.w3.org/2000/svg" width="96" height="96" viewBox="0 0 24 24" strokeWidth="0.5" stroke="#fff" fill="none" strokeLinecap="round" strokeLinejoin="round">
